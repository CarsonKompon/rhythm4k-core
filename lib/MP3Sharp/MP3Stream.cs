...
namespace MP3Sharp {
    ...
    public class MP3Stream : Stream {
        ...
        public MP3Stream(Stream sourceStream, int chunkSize) {
            ...
            switch (_ChannelCountRep) {
                ...
                case 2:
                    ...
                    break;
                default:
					Log.Error( $"Unhandled channel count rep: {_ChannelCountRep} (allowed values are 1-mono and 2-stereo).");
					break;
			}
        ...
        public override void Write(byte[] buffer, int offset, int count) {
			Log.Error( "Can't write to mp3stream" );
		}
        ...
        private bool ReadFrame() {
            ...
            try {
                ...
                if (decoderOutput != _Buffer) {
					Log.Error( "Output buffers are different.");
                }
            }
            finally {
